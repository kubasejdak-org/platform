...
set(PLATFORM_CXX_FLAGS              "${COMMON_FLAGS} -isystem ${ARM_CXX_INCLUDE_DIR} -stdlib=libstdc++ -nostdlib++ -fno-exceptions -Wno-unused-command-line-argument ${APP_CXX_FLAGS}" CACHE INTERNAL "")
